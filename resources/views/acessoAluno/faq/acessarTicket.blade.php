    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-start align-items-center">
                <a href="{{ route('aluno.faq') }}" title="Voltar" style="margin-right: 20px">
                ...
                <div class="chat-history-wrapper">
                    ...
                    @if($ticket->stTicket == "Aberto")
                        <div class="chat-history-footer">
                            <form action="{{ route('aluno.faq.ticket.addMensagem') }}" class="form-send-message d-flex justify-content-between align-items-center" method="post">
                                @csrf
...
document.getElementById('fecharTicket').addEventListener('click', ()=>{
    if(confirm('Tem certeza que deseja fechar este ticket?')){
        window.location.href = "{{ route('aluno.faq.ticket.encerrarTicket', $ticket->id) }}";
    }
})
</script>
