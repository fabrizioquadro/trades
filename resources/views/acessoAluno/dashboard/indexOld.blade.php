        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="table-responsive" style="min-height: 50px !important">
                    <table class='table table-sm table-filtro mt-3'>
                        ...
                        {{--  retirei a opção de aberto ou fechado para somente closed
                        <th>
                            <div style='display: flex'>
                                Status
                                <div class="dropdown">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-check mt-3">
                                                            ...
                                                            @endphp
                                                            <input class="form-check-input filtroStatus" {{ $controle }} type="checkbox" id='statusOpen' value="Open">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-check mt-3">
                                                            ...
                                                            @endphp
                                                            <input class="form-check-input filtroStatus" {{ $controle }} id='statusClosed' type="checkbox" value="Closed">
