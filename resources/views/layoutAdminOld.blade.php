...
<html
  lang="pt-br"
  class="light-style layout-navbar-fixed layout-menu-fixed layout-compact dark"
  dir="ltr"
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('corretoras') }}" class="menu-link">
                ...
                <div data-i18n="Email">Corretoras</div>
              </a>
            </li>
            <li class="menu-item">
