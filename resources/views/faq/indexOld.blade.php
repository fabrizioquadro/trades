                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="tabela-index" id="table-index">
                            <thead>
                                <tr>
                                    <th style="text-align:left !important">Número</th>
                                    <th style="text-align:left !important">Pergunta</th>
                                    <th style="text-align:left !important">Resposta</th>
                                    <th></th>
                                </tr>
                            </thead>
                            @foreach($faqs as $linha)
                              <tr>
                                  <td style="text-align:left !important">{{ $linha->numero }}</td>
                                  <td style="text-align:left !important">{{ $linha->pergunta }}</td>
                                  <td style="text-align:left !important">{{ $linha->resposta }}</td>
                                  <td>
                                    @if(auth()->user()->tipo == "Administrador")
                                        <div class="dropdown">
