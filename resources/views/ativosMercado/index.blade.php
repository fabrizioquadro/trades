...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h5 class="card-title">Ativos Mercado</h5>
                </div>
                @if(auth()->user()->tipo == "Administrador")
                    <div class="col-md-6" align='right'>
                        <a href="{{ route('ativosMercado.adicionar')}}" class="dt-button add-new btn btn-primary" type="button">
                          <span>
                        ...
                        <table class="tabela-index" id="table-index">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:left !important">Simbolo</th>
                                    <th></th>
                                </tr>
                            </thead>
                            @foreach($ativos as $linha)
                              <tr>
                                  <td style="text-align:left !important">{{ $linha->tipo }}</td>
                                  <td style="text-align:left !important">{{ $linha->simbolo }}</td>
                                  <td>
                                    @if(auth()->user()->tipo == "Administrador")
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-101.111px, 134.444px);">
                                              <a class="dropdown-item waves-effect" href="{{ route('ativosMercado.excluir', $linha->id) }}">
