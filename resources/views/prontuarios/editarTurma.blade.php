    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-start align-items-center">
                ...
                <h5 class="card-title">Editar Prontuário Turma</h5>
            </div>
            <form action="{{ route('prontuarioTurma.update') }}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="tag" class="form-control combobox" required>
                            <option></option>
                            @foreach($tags as $tag){
                                <option @if($tag->nmTag == $prontuario->tag) selected @endif value="{{ $tag->nmTag }}">{{ $tag->nmTag }}</option>
                            }
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12 form-group">
                        ...
                        <textarea id='editor' name="descricao" class="form-control">{{ $prontuario->descricao }}</textarea>
                    </div>
                </div>
                <div class="mt-4">
