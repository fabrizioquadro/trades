                        ...
                        <table class="table card-table">
                            <thead>
                                <tr>
                                    ...
                                    <td style="font-size: 16px !important"><b>Aluno</b></td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-size: 16px !important">{{ @$tradeMaiorGain->nmAluno }}</td>
                                    ...
                                    <td style="font-size: 16px !important">{{ @buscaPrefixoMoeda($tradeMaiorGain->moedaAtivo)." ".@valorDbForm($tradeMaiorGain->resPosicaoFinanceiro) }}</td>
                                    <td style="font-size: 16px !important">{{ @$moeda." ".@valorDbForm($tradeMaiorGain->resPosicaoFinanceiro * $tradeMaiorGain->$multiplicador) }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 16px !important">Maior Loss</td>
                                    <td style="font-size: 16px !important">{{ @$tradeMaiorLoss->nmAluno }}</td>
                                    <td style="font-size: 16px !important">{{ @$tradeMaiorLoss->idOperacao }}</td>
                                    <td style="font-size: 16px !important">{{ @$tradeMaiorLoss->moedaAtivo }}</td>
                                    <td style="font-size: 16px !important">{{ @buscaPrefixoMoeda($tradeMaiorLoss->moedaAtivo)." ".@valorDbForm($tradeMaiorLoss->resPosicaoFinanceiro) }}</td>
                                    <td style="font-size: 16px !important">{{ @$moeda." ".@valorDbForm($tradeMaiorLoss->resPosicaoFinanceiro * $tradeMaiorLoss->$multiplicador) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" style='min-height: auto !important'>
                        <table class="table card-table">
                            <thead>
                                <tr>
                                    <td style='font-size: 12px !important'><b>Aluno</b></td>
                            ...
                            <tbody>
                                @foreach($gains3Maiores as $gain)
                                    ...
                                    @endphp
                                    <tr>
                                        <td style='font-size: 12px !important'>{{ $gain->nmAluno }}</td>
                                        ...
                                        <td style='font-size: 12px !important'>{{ $moeda." ".valorDbForm($gain->resPosicaoFinanceiro * $gain->$multiplicador) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table card-table">
                            ...
                            <tbody>
                                @foreach($loss3Maiores as $loss)
                                    ...
                                    @endphp
                                    <tr>
                                        <td style='font-size: 12px !important'>{{ $loss->nmAluno }}</td>
                                        ...
                                        <td style='font-size: 12px !important'>{{ $moeda." ".valorDbForm($loss->resPosicaoFinanceiro * $loss->$multiplicador) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
            ...
            <div class="card" style='height: 100%'>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="vehicles-progress-label loading-text" style="width: {{ $tempo['contraTotalPorcentagem'] }}%">Contra-Tendência</div>
                    </div>
                    ...
                    <tbody>
                        @foreach($trades as $trade)
                            ...
                            <tr>
                                ...
                                <td style='font-size: 12px !important'>{{ $trade->nmAluno }}</td>
                                ...
                                <td style='font-size: 12px !important'>{{ $trade->moedaAtivo }}</td>
                                <td style='font-size: 12px !important'>{{ $trade->gainOrLoss }}</td>
                                <td style='font-size: 12px !important'>{{ buscaPrefixoMoeda($trade->moedaAtivo)." ".valorDbForm($trade->resPosicaoFinanceiro) }}</td>
                                <td style='font-size: 12px !important'>{{ $moeda." ".valorDbForm($trade->resPosicaoFinanceiro * $trade->$multiplicador) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
