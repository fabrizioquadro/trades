...
<form method="POST" action="{{ route('consistence.update') }}">
  @csrf
  <input type="hidden" name="controle" value="months">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <h5 class="card-title">Profitable Months</h5>
        </div>
        <div class="card mb-4">
            <div class="card-body pt-2 mt-1">
                <div class="row">
                    <div class="col-md-12 form-group">
                        <textarea id="editor" name="months" class="form-control">{{ $info->months }}</textarea>
                    </div>
                </div>
                <div class="mt-4">
